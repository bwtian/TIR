  ...
  <pipe>
    <rasterrenderer opacity="1" alphaBand="0" band="1" type="paletted">
      ...
      <colorPalette>
        ...
        <paletteEntry value="1" color="#000064" label="1"/>
        <paletteEntry value="2" color="#ff0000" label="2"/>
        <paletteEntry value="3" color="#0080ff" label="3"/>
        <paletteEntry value="4" color="#ffff00" label="4"/>
        <paletteEntry value="5" color="#c7ff00" label="5"/>
        <paletteEntry value="6" color="#00ff65" label="6"/>
        <paletteEntry value="7" color="#000000" label="7"/>
        <paletteEntry value="8" color="#2f8000" label="8"/>
        <paletteEntry value="9" color="#000000" label="9"/>
        <paletteEntry value="10" color="#826300" label="10"/>
        <paletteEntry value="11" color="#ffffff" label="11"/>
